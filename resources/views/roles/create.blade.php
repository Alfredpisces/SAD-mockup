...
@section('content')
    ...
    <div class="md:flex block items-center justify-between my-6 page-header-breadcrumb">
        <div>
            <h4 class="mb-0 text-defaulttextcolor font-medium">Add Role</h4>
            <nav>
                <ol class="flex items-center whitespace-nowrap min-w-0 mt-2">
                    ...
                    <li class="text-[0.813rem] before:content-['/'] before:mx-2 text-defaulttextcolor">Add Role</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="xl:col-span-8 col-span-12">
            <div class="box">
                <div class="box-header">
                    <h5 class="box-title">Role Information</h5>
                </div>
                <div class="box-body">
