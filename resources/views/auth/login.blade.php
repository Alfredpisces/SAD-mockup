<x-guest-layout>
    <div class="mb-6 text-center">
        <h2 class="text-2xl font-bold text-gray-800">Synth-Finance</h2>
        <p class="text-sm text-gray-600">Secure Investigator Access</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            <x-input-label for="password" :value="__('Access Key (Password)')" />
