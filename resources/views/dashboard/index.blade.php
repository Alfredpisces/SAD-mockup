        ...
        <div class="main-dashboard-header-right">
            <div>
                ...
                <div class="main-star">
                    ...
                    <i class="bi bi-star-fill text-warning"></i>
                    <i class="bi bi-star-fill text-warning"></i>
                    <i class="bi bi-star-fill text-textmuted op-8"></i>
                    <span class="text-defaulttextcolor text-[13px]">(14,873)</span>
                </div>
            </div>
            <div>
                    ...
                    <div class="hs-dropdown ti-dropdown">
                        <a aria-label="anchor" href="javascript:void(0);"
                            ...
                            data-bs-toggle="dropdown" aria-expanded="false"><i
                                class="fe fe-more-horizontal text-[0.8rem]"></i></a>
                ...
                <div class="box-body !p-0 customers mt-1">
                    <div class="ti-list-group ti-list-group-flush">
                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                            <div class="flex">
                                <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                    src="{{ asset('backend/assets/images/faces/3.jpg') }}" alt="img">
                                <div class="flex-grow">
                        ...
                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                            <div class="flex">
                                <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                    src="{{ asset('backend/assets/images/faces/11.jpg') }}" alt="img">
                                <div class="flex-grow">
                                    <div class="flex items-center">
                                        <div class="mt-1">
                        ...
                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                            <div class="flex">
                                <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                    src="{{ asset('backend/assets/images/faces/17.jpg') }}" alt="img">
                                <div class="flex-grow">
                                    <div class="flex items-center">
                                        <div class="mt-1">
                        ...
                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                            <div class="flex">
                                <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                    src="{{ asset('backend/assets/images/faces/15.jpg') }}" alt="img">
                                <div class="flex-grow">
                                    <div class="flex items-center">
                                        <div class="mt-1">
                        ...
                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                            <div class="flex">
                                <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                    src="{{ asset('backend/assets/images/faces/6.jpg') }}" alt="img">
                                <div class="flex-grow">
                                    <div class="flex items-center">
                                        <div class="mt-1">
            ...
            <div class="box">
                ...
                <div class="product-timeline box-body !pt-3">
                    <ul class="timeline-1 mb-0">
                        <li class="!mt-0">
                            <i class="fe fe-pie-chart bg-primary-gradient text-fixed-white product-icon"></i>
                            <span class="font-medium mb-4 text-[.875rem]">Total Products</span>
                            <a href="javascript:void(0);" class="float-end text-[.6875rem] text-textmuted">3 days ago</a>
                        ...
                        <li class="!mt-0">
                            ...
                            <span class="font-medium mb-4 text-[.875rem]">Total Sales</span>
                            <a href="javascript:void(0);" class="float-end text-[.6875rem] text-textmuted">35 mins ago</a>
                            <p class="mb-0 text-textmuted text-[.75rem]">1k New Sales</p>
                        </li>
                        <li class="!mt-0">
                            <i class="fe fe-bar-chart bg-success-gradient text-fixed-white product-icon"></i>
                            <span class="font-medium mb-4 text-[.875rem]">Total Revenue</span>
                            <a href="javascript:void(0);" class="float-end text-[.6875rem] text-textmuted">50 mins ago</a>
                            <p class="mb-0 text-textmuted text-[.75rem]">23.5K New Revenue</p>
                        </li>
                        <li class="!mt-0">
                            <i class="fe fe-box bg-warning-gradient text-fixed-white product-icon"></i>
                            <span class="font-medium mb-4 text-[.875rem]">Total Profit</span>
                            <a href="javascript:void(0);" class="float-end text-[.6875rem] text-textmuted">1 hour ago</a>
                            <p class="mb-0 text-textmuted text-[.75rem]">3k New profit</p>
                        </li>
                        <li class="!mt-0">
                            <i class="fe fe-eye bg-purple-gradient text-fixed-white product-icon"></i>
                            <span class="font-medium mb-4 text-[.875rem]">Customer Visits</span>
                            <a href="javascript:void(0);" class="float-end text-[.6875rem] text-textmuted">1 day ago</a>
                            <p class="mb-0 text-textmuted text-[.75rem]">15% increased</p>
                        </li>
                        <li class="!mt-0 !mb-0">
                            <i class="fe fe-edit bg-primary-gradient text-fixed-white product-icon"></i>
                            <span class="font-medium mb-4 text-[.875rem]">Customer Reviews</span>
                            <a href="javascript:void(0);" class="float-end text-[.6875rem] text-textmuted">1 day ago</a>
        ...
        <div class="md:col-span-12 lg:col-span-4 xl:col-span-4 col-span-12">
            <div class="box top-countries-card">
                <div class="box-header !border-b-0 !p-0">
                    <h4 class="box-title !mb-1">Your Top Countries</h4>
                    <span class="d-block text-textmuted font-normal text-[0.75rem] !mb-2">Sales performance revenue based
                        by country</span>
                </div>
